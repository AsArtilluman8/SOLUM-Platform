...
1. P55B visible Sky / Weather Core completion.
2. P52B verified public KTX/HDRI environment assets.
3. P53 Scene Workspace / multi-model scene.
4. P54 Asset Shelf.
5. P55 Transform Gizmo v1, renumber if needed after sky/weather P55.
...
```text
P55B — Visible Sky / Weather Core Pack
```

Main goal:

```text
Finish the first visible SOLUM-owned sky/weather layer while keeping Ultra Dynamic Sky local-reference-only.
```
...
- Sky / IBL has P51 Environment API controls, P52 asset status, and P55/P55B Sky/Weather Core controls. P55B visible stars/clouds/rain/snow are generated at runtime by SOLUM code, not imported assets.
...
- P55/P55B requires static checks first and one full build maximum unless a compile fix is needed.
...
- `docs/design/SOLUM_SKY_WEATHER_CORE.md`
- `docs/design/SOLUM_PRIVATE_ASSET_PIPELINE.md`
