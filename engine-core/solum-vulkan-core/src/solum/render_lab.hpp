...
struct RenderLabState {
    ...
    void writeJsonFields(std::ostream& f, const char* indent = "  ") const {
        ...
        f << indent << "  \"glassSlotsCount\": " << model.glassSlotsCount << ",\n";
        f << indent << "  \"glassSlotsDisplay\": \"" << escapeJson(model.glassSlotsDisplay) << "\",\n";
        f << indent << "  \"opaqueSlotsDisplay\": \"" << escapeJson(model.opaqueSlotsDisplay) << "\",\n";
        f << indent << "  \"cutoutSlotsDisplay\": \"" << escapeJson(model.cutoutSlotsDisplay) << "\",\n";
        f << indent << "  \"transparentGlassSlotLimit\": " << model.transparentGlassSlotLimit << ",\n";
        f << indent << "  \"transparentGlassSlotsRendered\": " << model.transparentGlassSlotsRendered << ",\n";
        f << indent << "  \"glassSingleSlotDrawRemoved\": \"" << escapeJson(model.glassSingleSlotDrawRemoved) << "\",\n";
        f << indent << "  \"glassUsesSlotList\": \"" << escapeJson(model.glassUsesSlotList) << "\",\n";
        f << indent << "  \"glassSlotListStatus\": \"" << escapeJson(model.glassSlotListStatus) << "\",\n";
        f << indent << "  \"glassActiveSlotCount\": " << model.glassActiveSlotCount << ",\n";
        f << indent << "  \"glassActiveSlotList\": \"" << escapeJson(model.glassActiveSlotList) << "\",\n";
        f << indent << "  \"glassLiveOpacity\": " << model.glassLiveOpacity << ",\n";
        f << indent << "  \"glassShaderOpacityInput\": " << model.glassShaderOpacityInput << ",\n";
        f << indent << "  \"glassLiveClarity\": " << model.glassLiveClarity << ",\n";
        f << indent << "  \"glassShaderClarityInput\": " << model.glassShaderClarityInput << ",\n";
        f << indent << "  \"glassLiveThickness\": " << model.glassLiveThickness << ",\n";
        f << indent << "  \"glassShaderThicknessInput\": " << model.glassShaderThicknessInput << ",\n";
        f << indent << "  \"glassPresetMixRemovedStatus\": \"" << escapeJson(model.glassPresetMixRemovedStatus) << "\",\n";
        f << indent << "  \"glassPresetMixInShader\": \"" << escapeJson(model.glassPresetMixInShader) << "\",\n";
        f << indent << "  \"glassUsesNormalMaterialRgb\": \"" << escapeJson(model.glassUsesNormalMaterialRgb) << "\",\n";
        f << indent << "  \"glassFinalVisualVerified\": \"" << escapeJson(model.glassFinalVisualVerified) << "\",\n";
        f << indent << "  \"glassEnabledControlsShaderBranch\": \"" << escapeJson(model.glassEnabledControlsShaderBranch) << "\",\n";
        f << indent << "  \"glassOpacityZeroExpectedCenterClear\": \"" << escapeJson(model.glassOpacityZeroExpectedCenterClear) << "\",\n";
        f << indent << "  \"glassOpacitySixExpectedCenterDense\": \"" << escapeJson(model.glassOpacitySixExpectedCenterDense) << "\",\n";
        f << indent << "  \"glassDebugTruthStatus\": \"" << escapeJson(model.glassDebugTruthStatus) << "\",\n";
        ...
        f << indent << "  \"selectedMaterialSlotIndex\": " << model.selectedMaterialSlotIndex << ",\n";
        f << indent << "  \"selectedMaterialSlotName\": \"" << escapeJson(model.selectedMaterialSlotName) << "\",\n";
        f << indent << "  \"selectedMaterialSlotRole\": \"" << escapeJson(model.selectedMaterialSlotRole) << "\",\n";
        f << indent << "  \"manualGlassSlotIndex\": " << model.manualGlassSlotIndex << ",\n";
        f << indent << "  \"manualGlassSlotName\": \"" << escapeJson(model.manualGlassSlotName) << "\",\n";
        f << indent << "  \"opaquePassSkippedGlassSlots\": \"" << escapeJson(model.opaquePassSkippedGlassSlots) << "\",\n";
        ...
        f << indent << "  \"glassTrapLastFrameActive\": \"" << escapeJson(model.glassTrapLastFrameActive) << "\",\n";
        f << indent << "  \"glassTrapLastFrameAnyCleanPath\": \"" << escapeJson(model.glassTrapLastFrameAnyCleanPath) << "\",\n";
        f << indent << "  \"glassTrapLastFrameAnyOldFallback\": \"" << escapeJson(model.glassTrapLastFrameAnyOldFallback) << "\",\n";
        f << indent << "  \"glassTrapLastFrameAnyOpaqueGlass\": \"" << escapeJson(model.glassTrapLastFrameAnyOpaqueGlass) << "\",\n";
        f << indent << "  \"glassTrapLastFrameAnyTransparentGlass\": \"" << escapeJson(model.glassTrapLastFrameAnyTransparentGlass) << "\",\n";
        f << indent << "  \"glassTrapLastFrameAnyFullShaderTest\": \"" << escapeJson(model.glassTrapLastFrameAnyFullShaderTest) << "\",\n";
        f << indent << "  \"glassTrapLastFrameAnySlotHeatmap\": \"" << escapeJson(model.glassTrapLastFrameAnySlotHeatmap) << "\",\n";
        f << indent << "  \"glassTrapLastDrawSlotIndex\": " << model.glassTrapLastDrawSlotIndex << ",\n";
        f << indent << "  \"glassTrapLastDrawMaterialName\": \"" << escapeJson(model.glassTrapLastDrawMaterialName) << "\",\n";
        f << indent << "  \"glassTrapLastDrawPassName\": \"" << escapeJson(model.glassTrapLastDrawPassName) << "\",\n";
        f << indent << "  \"glassTrapLastDrawCleanPathUsed\": \"" << escapeJson(model.glassTrapLastDrawCleanPathUsed) << "\",\n";
        f << indent << "  \"glassTrapLastDrawOldFallbackUsed\": \"" << escapeJson(model.glassTrapLastDrawOldFallbackUsed) << "\",\n";
        f << indent << "  \"glassTrapLastDrawOpaqueUsed\": \"" << escapeJson(model.glassTrapLastDrawOpaqueUsed) << "\",\n";
        f << indent << "  \"glassTrapLastDrawTransparentUsed\": \"" << escapeJson(model.glassTrapLastDrawTransparentUsed) << "\",\n";
        f << indent << "  \"glassTrapLastDrawOpacity\": " << model.glassTrapLastDrawOpacity << ",\n";
        f << indent << "  \"glassTrapLastDrawEdge\": " << model.glassTrapLastDrawEdge << ",\n";
        f << indent << "  \"glassTrapLastDrawTintPreset\": " << model.glassTrapLastDrawTintPreset << ",\n";
        f << indent << "  \"glassTrapLastDrawClarity\": " << model.glassTrapLastDrawClarity << ",\n";
        f << indent << "  \"glassTrapLastDrawThickness\": " << model.glassTrapLastDrawThickness << ",\n";
        f << indent << "  \"glassTrapLastDrawRoughness\": " << model.glassTrapLastDrawRoughness << ",\n";
        f << indent << "  \"glassTrapLastDrawFormulaVersion\": \"" << escapeJson(model.glassTrapLastDrawFormulaVersion) << "\",\n";
