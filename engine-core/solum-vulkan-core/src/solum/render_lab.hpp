...
struct RenderLabState {
    ...
    void writeJsonFields(std::ostream& f, const char* indent = "  ") const {
        ...
        f << indent << "  \"routeMetalCount\": " << model.routeMetalCount << ",\n";
        f << indent << "  \"routeChromeCount\": " << model.routeChromeCount << ",\n";
        f << indent << "  \"routeMirrorCount\": " << model.routeMirrorCount << ",\n";
        f << indent << "  \"routeFoliageCutoutCount\": " << model.routeFoliageCutoutCount << ",\n";
        f << indent << "  \"routeFabricHairCount\": " << model.routeFabricHairCount << ",\n";
        f << indent << "  \"routeEmissionCount\": " << model.routeEmissionCount << ",\n";
        f << indent << "  \"routeDecalCount\": " << model.routeDecalCount << ",\n";
        f << indent << "  \"routeUnknownCount\": " << model.routeUnknownCount << ",\n";
        ...
        f << indent << "  \"runtimeMaterialClassStatus\": \"" << escapeJson(model.runtimeMaterialClassStatus) << "\",\n";
        f << indent << "  \"opaqueDrawRangeCount\": " << model.opaqueDrawRangeCount << ",\n";
        f << indent << "  \"cutoutDrawRangeCount\": " << model.cutoutDrawRangeCount << ",\n";
        f << indent << "  \"glassMaterialCount\": " << model.glassMaterialCount << ",\n";
        f << indent << "  \"glassDrawRangeCount\": " << model.glassDrawRangeCount << ",\n";
        f << indent << "  \"glassQueueDrawn\": " << (model.glassQueueDrawn ? "true" : "false") << ",\n";
        f << indent << "  \"glassPipelineCreated\": " << (model.glassPipelineCreated ? "true" : "false") << ",\n";
        f << indent << "  \"glassPipelineBound\": " << (model.glassPipelineBound ? "true" : "false") << ",\n";
        f << indent << "  \"glassBlendEnabled\": " << (model.glassBlendEnabled ? "true" : "false") << ",\n";
        f << indent << "  \"glassDepthWriteEnabled\": " << (model.glassDepthWriteEnabled ? "true" : "false") << ",\n";
        f << indent << "  \"opaqueSkippedGlass\": " << (model.opaqueSkippedGlass ? "true" : "false") << ",\n";
        f << indent << "  \"glassOpacityCurrent\": " << model.glassOpacityCurrent << ",\n";
        f << indent << "  \"glassEnabled\": " << (model.glassEnabled ? "true" : "false") << ",\n";
        f << indent << "  \"glassMissingNormalCount\": " << model.glassMissingNormalCount << ",\n";
        f << indent << "  \"glassNormalStatus\": \"" << escapeJson(model.glassNormalStatus) << "\",\n";
        f << indent << "  \"glassRouteStatus\": \"" << escapeJson(model.glassRouteStatus) << "\",\n";
        f << indent << "  \"selectedMaterialIndex\": " << model.selectedMaterialIndex << ",\n";
        f << indent << "  \"selectedAlphaMode\": \"" << escapeJson(model.selectedAlphaMode) << "\",\n";
        f << indent << "  \"selectedBaseColorAlpha\": " << model.selectedBaseColorAlpha << ",\n";
        f << indent << "  \"selectedSemanticGlass\": " << (model.selectedSemanticGlass ? "true" : "false") << ",\n";
