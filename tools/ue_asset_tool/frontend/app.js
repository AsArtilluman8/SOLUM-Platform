...
function renderHero() {
  ...
  grid.append(
    ...
    metric("Assets", state.inventory.totals.assets), metric("Exact audio", state.gate.audio_outputs)
  );
  root.append(grid);
...
function renderOverview() {
  ...
  stack.append(card("Runtime truth", "NOT YET EXECUTABLE — VERIFIED GRAPH/DATA CONTRACT ONLY", "banner"));
